...
| # | 模块 | 文件 |
|---|------|------|
| 1 | 认证与授权 | [01-auth.md](./01-auth.md) |
| 2 | 会话管理 | [02-session.md](./02-session.md) |
| 3 | 消息与对话 | [03-messaging.md](./03-messaging.md) |
| 4 | Remote Tool Call 系统 | [04-rtc.md](./04-rtc.md) |
| 5 | 虚拟文件系统 | [05-virtual-fs.md](./05-virtual-fs.md) |
| 6 | 脚本执行引擎 | [06-script-engine.md](./06-script-engine.md) |
| 7 | 工作模式系统 | [07-work-modes.md](./07-work-modes.md) |
